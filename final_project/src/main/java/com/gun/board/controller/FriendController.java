...
public class FriendController {
	...
	/*
	 * @RequestMapping(value = "/management", method = RequestMethod.GET) public
	 * String management(Model model) { String cus_id = (String)
	 * session.getAttribute("loginid"); ArrayList<String> friends =
	 * fRepository.getList(cus_id); model.addAttribute("friends", friends);
	 * ArrayList<String> request = fRepository.getRequestList(cus_id);
	 * model.addAttribute("request", request); logger.info("friends: " +
	 * friends.size() + " , request: " + request.size()); return
	 * "friend/management"; }
	 */
