		...
		<div class="nt-container px-0 px-sm-4 px-xl-0 pt-0 pt-sm-4">
			<div class="ArticleTopBtns">
				<div class="right_area">
					...
					<a href="${pageContext.request.contextPath}/boards_data" role="button"
						class="BaseButton BaseButton--skinGray size_default"> <input
				...
				<div class="article_header">
					<div class="ArticleTitle">
						...
						<div class="title_area">
							...
							<!---->
							<!--제목 시작 단-->
							<h3 class="title_text">${data.board_title}</h3>
						</div>
					</div>
					<div class="WriterInfo">
						...
						<div class="profile_area">
							...
							<span class="date"> <fmt:formatDate
										value="${data.board_date }" pattern="yyyy-MM-dd HH:mm:ss" />

								</span> <span class="count">조회 ${data.board_hits}</span>
							</div>
						</div>
					</div>
					<div class="ArticleTool">
						<a href="#" role="button" class="button_comment"><svg
							...
							<strong class="num">${data.board_replies }</strong></a><a href="#" role="button"
								...
								<div class="product_section">
									<div class="ProductImage sold">
										<div class="product_thumb">
											...
											<img
												src="${pageContext.request.contextPath}/boards_data/download?board_num=${data.board_num}"
												...
												<div class="se-section se-section-text se-l-default">
													<div class="se-module se-module-text">
														...
														<p class="se-text-paragraph se-text-paragraph-align-left "
															...
															<span style="" class="se-fs- se-ff-">${data.board_content }</span>
														</p>
													</div>
												</div>
											</div>
					...
					<div class="article_writer">
						<div class="ArticleWriterProfile">
							<a href="/ca-fe/cafes/10050146/members/prkQguvG11zjC0KAkeAh_A"
								...
								class="box"><strong class="user">${data.board_nickname }</strong>님의
								...
								<div class="comment_attach">
									<div data-v-3b426d7d="" class="register_box">
										...
										<a href="#" role="button" id="insertReply" name="insertReply"
											class="button btn_register">등록2</a>
									</div>
								</div>
							</div>
						</c:if>
