...
<script>
		...
		$(function(){
			$('#sortNew').on("click",function(){
				...
				alert(sortValue);
				location.href = "${pageContext.request.contextPath}/boards_free/SortFree?sortValue="+sortValue;
				...
				<div id="bo_list_wrap" class="mb-4">
					...
					<div id="bo_search" class="collapse">
						<div class="alert bg-light border p-2 p-sm-3 mb-3 mx-3 mx-sm-0">
							<!-- 검색창 폼 만들어야함 -->
							<form
								action="${pageContext.request.contextPath}/boards_free/findfree"
							...
							<!--  
				<form action="${pageContext.request.contextPath}/notice/findNotice" method="post">
						...
						<div class="d-sm-flex align-items-center">
							...
							<div class="px-3 px-sm-0 text-right">
								...
								<button type="button" class="btn btn_b01 nofocus p-1"
									...
									<a href="${pageContext.request.contextPath}/boards_free/insert" class="btn btn-primary nofocus py-1 ml-2" role="button"> <i
									...
									<li
										...
										<div class="d-md-table-cell text-center py-md-2 pr-md-1">
											<div class="na-title float-md-left">
												<div class="na-item">
													<a
														href="${pageContext.request.contextPath}/boards_free/get?board_num=${item.board_num}&page=${page}&friend_id=${friend_id}">${item.board_title}
		...
		<div class="font-weight-normal px-3 px-sm-0">
			<ul class="pagination justify-content-center en mb-0">
				<li class="page-item"><a
					href="${pageContext.request.contextPath}/boards_free?page=${page-1}&friend_id=${friend_id}">&laquo;</a></li>
				<c:forEach var="page" begin="${page}" end="${endPage }">
					<li><a
						href="${pageContext.request.contextPath}/boards_free?page=${page}&friend_id=${friend_id}">${page}</a></li>
				</c:forEach>
				<li class="page-item"><a
					href="${pageContext.request.contextPath}/boards_free?page=${page+1}&friend_id=${friend_id}">&raquo;</a></li>
